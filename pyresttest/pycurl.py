# encoding: utf-8
# module pycurl
# from C:\python36\lib\site-packages\pycurl.cp36-win_amd64.pyd
# by generator 1.146
"""
...
COMPILE_LIBCURL_VERSION_NUM = 474112

COMPILE_PY_VERSION_HEX = 50725616
...
OPT_CERTINFO = 172
OPT_COOKIELIST = 10135
OPT_FILETIME = 69

OPT_RTSP_CLIENT_CSEQ = 193

OPT_RTSP_REQUEST = 189

OPT_RTSP_SERVER_CSEQ = 194

OPT_RTSP_SESSION_ID = 10190

OPT_RTSP_STREAM_URI = 10191

OPT_RTSP_TRANSPORT = 10192
...
version = 'PycURL/7.43.0.2 libcurl/7.60.0 OpenSSL/1.1.0h zlib/1.2.11 c-ares/1.14.0 WinIDN libssh2/1.8.0 nghttp2/1.32.0'
...
class Curl(object):
    ...
    def errstr_raw(self): # real signature unknown; restored from __doc__
        """
    ...
    def getinfo(self, option): # real signature unknown; restored from __doc__
        """
    ...
    def getinfo_raw(self, option): # real signature unknown; restored from __doc__
        """
    ...
    def perform_rb(self): # real signature unknown; restored from __doc__
        """
    ...
    def perform_rs(self): # real signature unknown; restored from __doc__
        """
    ...
    def set_ca_certs(self): # real signature unknown; restored from __doc__
        """
        set_ca_certs() -> None
